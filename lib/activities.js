...
export const activities = [
  ...
  },
  {
    ...
    bookable: true,
    privative: true,
    // Auto-attribution de salle selon nombre de joueurs (runtime)
    rooms: [
      { id: 'k7-studio', name: 'Studio', maxPlayers: 8 },
      { id: 'k7-record', name: 'Record', maxPlayers: 8 },
      { id: 'k7-dancefloor', name: 'Dancefloor', maxPlayers: 18 },
    ],
  },
  {
    id: 'slashhit',
