...
export default function Header() {
  ...
  return (
    ...
    <header className="sticky top-0 z-40 border-b border-white/[0.08] bg-mw-bg/95 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-2 md:py-3">
        <Link href="/booking" className="flex items-center gap-2 shrink-0">
          <Image src="/images/brand/logo.png" alt="Multiwex" width={48} height={48} priority className="h-8 w-auto md:h-9" />
        </Link>
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center justify-center rounded border border-white/20 bg-white/[0.03] px-3 py-2 text-xs font-bold text-white transition hover:border-mw-pink"
            >
              {lang}
            </button>
            {langOpen && (
          ...
          <Link
            href="/staff/login"
            className="flex items-center justify-center rounded border border-white/15 bg-white/[0.02] p-2 text-white/40 transition hover:border-mw-pink hover:text-mw-pink"
