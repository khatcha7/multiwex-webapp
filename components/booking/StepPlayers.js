  ...
  return (
    <div>
      ...
      <p className="mb-6 text-white/60">
        Ce nombre s'applique à toutes vos activités. Capacité maximum autorisée&nbsp;: <span className="font-bold text-mw-pink">{maxCap}</span>.
      </p>
      <div className="mb-8 flex items-center justify-center gap-4 rounded-2xl border border-white/10 bg-white/[0.03] p-8">
        ...
        <div className="w-20 text-center">
          <div className="text-6xl font-black text-mw-pink">{cart.players}</div>
