  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6">
      ...
      {tab === 'chatbot_config' && (<div className="mb-6 rounded border border-white/10 bg-mw-surface p-5">
        ...
        <div className="mb-4 rounded border border-mw-cyan/30 bg-mw-cyan/5 p-3">
          <label className="flex cursor-pointer items-center gap-2 text-sm">
            <input
              ...
              className="h-4 w-4 cursor-pointer accent-mw-cyan"
            />
            <span className="display text-mw-cyan">✨ Activer Ellie IA (réservation conversationnelle)</span>
          </label>
          <p className="mt-2 pl-6 text-xs text-white/60">
